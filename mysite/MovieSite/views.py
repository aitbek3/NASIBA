...
class CountryEditAPIView(generics.RetrieveAPIView):
    queryset = Country.objects.all()
...
class DirectorEditAPIView(generics.RetrieveAPIView):
    queryset = Director.objects.all()
...
class ActorEditAPIView(generics.RetrieveAPIView):
    queryset = Actor.objects.all()
...
class GenreEditAPIView(generics.RetrieveAPIView):
    queryset = Genre.objects.all()
...
class MovieDetailAPIView(generics.RetrieveAPIView):
    ...
    permission_classes = [CheckStatus, CheckUserRating]

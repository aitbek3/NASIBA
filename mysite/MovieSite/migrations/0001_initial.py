# Generated by Django 5.1.4 on 2024-12-15 08:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('types', models.CharField(choices=[('144p', '144p'), ('360p', '360p'), ('480p', '480p'), ('720p', '720p'), ('1080p', '1080p')], max_length=16)),
                ...
                ('status_movie', models.CharField(choices=[('pro', 'pro'), ('simple', 'simple')], max_length=16)),
                ('actor', models.ManyToManyField(to='MovieSite.actor')),
                ('country', models.ManyToManyField(to='MovieSite.country')),
                ('director', models.ManyToManyField(to='MovieSite.director')),
                ('genre', models.ManyToManyField(to='MovieSite.genre')),
            ],
        ),
        migrations.CreateModel(
            name='Moments',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='MovieSite.movie')),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='MovieSite.rating')),
